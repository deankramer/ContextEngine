...
public class LightContext extends ListenerComponent implements
		SensorEventListener {
	...
	/*
	 * private static final double HIGH_LUM_VALUE = 180; private static final
	 * double MEDIUM_LUM_VALUE = 100;
	 */
	private String lastC;

	public LightContext(Context c) {

		super("LightContext", c, Sensor.TYPE_LIGHT,

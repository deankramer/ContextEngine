...
public class CompositeComponent extends Component implements Serializable{
	...
	public CompositeComponent(String name, Context c, ArrayList<String> pc, ArrayList<String> nc){
		super(name, c);
		positivecontexts = new Hashtable<String, Boolean>();
		setupMonitor();
		for(String cn : pc)
	...
	public boolean registerComponent(ArrayList<String> contextList, Boolean value){
